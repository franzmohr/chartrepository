# macro, forecast, inflation, projection
...
actual <- get_eurostat(id = "prc_hicp_aind",
...
ggsave(g, filename = "figures/inflation_projections_for_eu_countries.png", height = 3.5, width = 8)
