# bank, macro, credit, growth, household, consumption
...
# Download data
result <- get_data("BSI.M..N.A.A21.A.I.U2.2250.Z01.A") %>%
...
ggsave(g, filename = "figures/bank_household_consumption_credit_growth_line_chart.png", height = 4, width = 11)
